...
export default function ModalCreateTask({ modalOpen, setModalOpen, list }: ModalProps) {
    return (
        <>
            <div
                id="createTaskModal"
                            ...
                            <div className="grid md:grid-cols-4 md:gap-6">
                                ...
                                <div className="relative z-0 w-full mb-6 group">
                                    <div className="flex items-center">
                                        <select name="floating_last_name" id="floating_last_name" className="block py-2.5 pr-8 pl-0 w-full text-sm text-gray-900 bg-gray-800 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required>
